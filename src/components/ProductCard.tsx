  ...
  const [isHovered, setIsHovered] = useState(false);
          ...
          {stock !== undefined && stock <= 5 && (
            <div className="absolute top-4 right-4 z-10">
              <span className="font-body text-[9px] tracking-wider uppercase px-2.5 py-1 rounded-full bg-red-900/70 backdrop-blur-md text-red-200 border border-red-500/30 shadow-lg flex items-center gap-1 animate-pulse">
