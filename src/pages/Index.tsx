...
const sobEncomenda = [
  ...
  },
  {
    ...
    brand: "Lattafa Perfumes",
    image: imgFakhar,
    category: "Aromático Fresco",
    topNotes: "Maçã e Bergamota",
    heartNotes: "Sálvia, Lavanda e Bagas de Zimbro",
    baseNotes: "Madeira Âmbar, Fava Tonka, Cedro e Vetiver",
    pricePix: "Sob consulta",
    priceCredit: "Sob consulta",
  ...
  },
  {
    ...
    topNotes: "Pera, Lavanda e Hortelã",
    heartNotes: "Canela e Baunilha Negra",
    ...
    <div className="min-h-screen bg-background relative">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 py-3 sm:py-4 px-4 sm:px-6 flex items-center justify-between bg-background/60 backdrop-blur-xl border-b border-border/20" role="navigation" aria-label="Navegação principal">
        <div className="flex items-center gap-2 sm:gap-3">
          <img src={logoLgs} alt="LGs Perfumes" className="w-8 h-8 sm:w-10 sm:h-10 object-contain" width={40} height={40} />
          <span className="font-display text-base sm:text-lg gold-gradient-text hidden xs:block">LGs Perfumes</span>
        </div>
        ...
        <div className="relative z-10 text-center px-4 sm:px-6 max-w-3xl w-full">
          ...
          <div className="animate-hero-1 flex justify-center mb-6 sm:mb-8">
            <img
              src={logoLgs}
              alt="LGs Perfumes"
              className="w-28 h-28 sm:w-36 sm:h-36 md:w-48 md:h-48 object-contain drop-shadow-[0_0_40px_hsl(42_65%_52%/0.3)]"
              width={192}
              height={192}
            />
          </div>
